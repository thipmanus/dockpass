...
- Admin dashboard has active round and ถังขยะ tabs.
...
The MVP does not send real email. Admins assign emails in the app; users open the portal and sign in with Google.
...
- CSV import/export for assignees.
